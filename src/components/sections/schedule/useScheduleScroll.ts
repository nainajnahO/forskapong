...
import { EVENTS, PHASES, BOTTOM_PADDING, progressToMinute, formatMinutesToClock } from './schedule-data'

export function useScheduleScroll(sectionRef: React.RefObject<HTMLDivElement | null>, headerRef: React.RefObject<HTMLDivElement | null>) {
