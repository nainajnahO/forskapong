...
export const VENUE_MAP_CONFIG = {
  ...
  cameraWaypoints: [
    ...
    { progress: 0.058824, center: [17.621617, 59.845779] as const, zoom: 12.3, pitch: 58, bearing: 20 },
    { progress: 0.117647, center: [17.636039, 59.842292] as const, zoom: 14, pitch: 70, bearing: -1 },
    { progress: 0.176471, center: [17.638297, 59.843025] as const, zoom: 15.17, pitch: 81, bearing: -10 },
    { progress: 0.235294, center: [17.639002, 59.842657] as const, zoom: 16.89, pitch: 85, bearing: -9 },
    { progress: 0.294118, center: [17.637539, 59.84638] as const, zoom: 17.29, pitch: 85, bearing: -9 },
    { progress: 0.352941, center: [17.637044, 59.847715] as const, zoom: 17.55, pitch: 85, bearing: -9 },
    { progress: 0.411765, center: [17.636222, 59.850066] as const, zoom: 17.55, pitch: 85, bearing: -9 },
    { progress: 0.470588, center: [17.635677, 59.85032] as const, zoom: 17.92, pitch: 85, bearing: -17 },
    { progress: 0.529412, center: [17.633728, 59.852406] as const, zoom: 17.92, pitch: 84, bearing: -22 },
    { progress: 0.588235, center: [17.631654, 59.855028] as const, zoom: 17.92, pitch: 84, bearing: -22 },
    { progress: 0.647059, center: [17.631799, 59.856401] as const, zoom: 17.92, pitch: 85, bearing: -10 },
    { progress: 0.705882, center: [17.631436, 59.858574] as const, zoom: 17.92, pitch: 85, bearing: -10 },
    { progress: 0.764706, center: [17.631108, 59.859077] as const, zoom: 17.89, pitch: 81, bearing: -18 },
    { progress: 0.823529, center: [17.630444, 59.859412] as const, zoom: 17.89, pitch: 84, bearing: -36 },
    { progress: 0.882353, center: [17.629533, 59.85922] as const, zoom: 17.89, pitch: 84, bearing: -64 },
    { progress: 0.941176, center: [17.629466, 59.859193] as const, zoom: 18.47, pitch: 82, bearing: -89 },
